...
if mode == "train":
    # Configure dataset.
    dataset_dir           = r"D:\dc\python\DCGAN-PyTorch-master\datasets\panel\images\train"                      # The address of the training dataset.
    image_size            = 512                          # Generator image size.
    ...
    resume_d_weight       = r"D:\dc\python\DCGAN-PyTorch-master\results\exp000\ori300d-last.pth"                          # Restore the weight of the discriminator model during training.
    resume_g_weight       = r"D:\dc\python\DCGAN-PyTorch-master\results\exp000\ori300g-last.pth"                          # Restore the weight of the generator model during training.
...
if mode == "valid":
    ...
    model_path = r"D:\dc\python\DCGAN-PyTorch-master\results\exp000/300g-last.pth"
