...
def main() -> None:
    ...
    dataset = torchvision.datasets.ImageFolder(root=r'D:\dc\python\DCGAN-PyTorch-master\datasets\panel\images',transform=transform)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if epoch % 50 == 0:
            ...
            torch.save(discriminator.state_dict(), os.path.join(exp_dir2, f"{epoch}d-last.pth"))
            # torch.save(generator.state_dict(), os.path.join(exp_dir2, f"{epoch}g-last.pth"))
    #
    # # Save the weight of the model under the last Epoch in this stage.
