...
class Discriminator(nn.Module):
    def __init__(self) -> None:
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv2d(3, 32, (4, 4), (2, 2), (1, 1), bias=True),
            nn.LeakyReLU(0.2, True),
            ...
            # State size. 512 x 4 x 4
            nn.Conv2d(1024, 1, (4, 4), (1, 1), (0, 0), bias=True),
            nn.Sigmoid()
        )
...
class Generator(nn.Module):
    def __init__(self) -> None:
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d(100, 1024, (4, 4), (1, 1), (0, 0), bias=False),
            nn.BatchNorm2d(1024),
            nn.ReLU(True),
            # state size. 512 x 4 x 4
            ...
            # state size. 64 x 32 x 32
            nn.ConvTranspose2d(32, 3, (4, 4), (2, 2), (1, 1), bias=True),
            nn.Tanh()
